...
export const REAL_DISTRACTION_PENALTY = 15;
export const CONTEXT_SWITCH_FREE_LIMIT = 5;
export const CONTEXT_SWITCH_PENALTY = 2;
export const IDLE_PENALTY = 20;
export const PANIC_SWITCH_PENALTY_SINGLE = 5;
export const PANIC_SWITCH_PENALTY_MULTI = 0;
export const BONUS_CLEAN_SESSION = 10;
export const BONUS_DEEP_FOCUS = 15;
export const BONUS_CONSISTENCY = 20;
export const BONUS_RECOVERY = 5;
export const DEEP_FOCUS_THRESHOLD_MINUTES = 5;
export const STREAK_MIN_SESSION_MINUTES = 2;
export const IDLE_THRESHOLD_MS = 15 * 60 * 1000;
export const IDLE_NUDGE_MS = 60 * 1000;
export const PANIC_THRESHOLD_MS = 30 * 1000;
